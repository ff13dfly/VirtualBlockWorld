...
虚块世界由逐月发行的相对独立的世界构成，每个世界由2048 x 2048块土地构成，每块土地的尺寸为32m x 32m的方块，每块土地发行100枚VBC，用于土地买卖、物品买卖、支付服务器费用等。每个世界，发行对应的419,430,400枚(100x2048x2048)流通虚拟币VBC(Virtual Block Coin)。
